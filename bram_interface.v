...
module bram_interface (
    ...
    input  wire        ld_wstrb,    // byte enable
    output wire        ld_ack,

    // --- Doğrudan okuma (debug) ---
    input  wire [31:0] dbg_addr,
    output wire [31:0] dbg_rdata
);

    (* ram_style = "block" *) reg [31:0] bram [0:1023];
    ...
    // CPU senkron yazma + ready (yalnızca BRAM bölgesi)
    ...
    // Loader byte yazma (öncelik: loader reset sırasında tek yazıcı)
    always @(posedge clk) begin
